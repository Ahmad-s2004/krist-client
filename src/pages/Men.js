...
const Men = () => {
  ...
  const fetchData = async () => {
    const res = await fetch(`${API_URL}/product/getMen`);
  ...
  const fetchFilteredProducts = async (searchString) => {
    const res = await fetch(`${API_URL}/product/getMenProducts?search=${searchString}`);
    const data = await res.json();
    setProduct(data);
  };
            ...
            <ul className='filter'>
              ...
              <li className='d-flex flex-column align-items-start '>
                ...
                <div className='colorScroll'>
                  ...
                  <div onClick={() => handleFilterClick("Men's Jacket")}>Jacket</div>
                  <div onClick={() => handleFilterClick('Casual Shirts')}>Casual Shirts</div>
                  <div onClick={() => handleFilterClick('Shoes')}>Shoes</div>
                </div>
              </li>
            </ul>
          </ul>
